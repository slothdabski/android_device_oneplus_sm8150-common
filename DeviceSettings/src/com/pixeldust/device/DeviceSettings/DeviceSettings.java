...
*
*/
package com.pixeldust.device.DeviceSettings;
...
import com.pixeldust.device.DeviceSettings.FileUtils;
import com.pixeldust.device.DeviceSettings.Constants;
import com.pixeldust.device.DeviceSettings.R;
import com.pixeldust.device.DeviceSettings.SuShell;
import com.pixeldust.device.DeviceSettings.SuTask;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), com.pixeldust.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
